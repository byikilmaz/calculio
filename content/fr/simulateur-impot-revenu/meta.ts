...
export const content: ToolContent = {
  meta: {
    title: "Simulateur Impôt sur le Revenu 2025 | Calculio",
    description:
      "Calculez gratuitement votre impôt sur le revenu 2025 selon le barème officiel. Quotient familial, parts fiscales et taux marginal inclus.",
  },
  h1: "Simulateur Impôt sur le Revenu 2025 — Gratuit",
  intro:
    "Estimez immédiatement votre impôt sur le revenu 2025 à partir du barème officiel publié par la DGFiP. Prise en compte des parts fiscales et du plafonnement du quotient familial.",
  explanation: {
    title: "Comment fonctionne l'impôt sur le revenu 2025 ?",
    body: `L'impôt sur le revenu (IR) en France est un impôt **progressif** : plus vos revenus augmentent, plus le taux d'imposition s'applique sur les tranches supérieures. Le barème 2025, voté en loi de finances et applicable aux revenus 2024, se compose de cinq tranches principales.

Les tranches du barème progressif 2025 sont :
...
Le **plafonnement du quotient familial** limite l'avantage fiscal lié aux personnes à charge à **1 759 € par demi-part** supplémentaire en 2025. Au-delà de ce plafond, la réduction d'impôt est rabotée. Cela concerne principalement les foyers à revenus élevés avec plusieurs enfants.
...
Attention, ce simulateur ne prend pas en compte les **réductions et crédits d'impôt** (dons, emploi à domicile, PER, investissements Pinel/Denormandie, frais de garde d'enfants) ni la **Contribution Exceptionnelle sur les Hauts Revenus** (CEHR) qui s'applique au-delà de 250 000 € pour un célibataire. Pour une déclaration officielle, rendez-vous sur impots.gouv.fr.`,
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Pour éviter que les foyers à hauts revenus profitent trop fortement de l'avantage des parts, l'administration plafonne la réduction d'impôt à 1 759 € par demi-part supplémentaire en 2025. Si votre avantage théorique dépasse ce plafond, l'impôt est recalculé sans en tenir compte intégralement.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Non. Il fournit une estimation précise du barème 2025 mais n'intègre pas les réductions et crédits d'impôt, la contribution exceptionnelle sur les hauts revenus (CEHR), les revenus exceptionnels soumis au quotient, ni les régimes spécifiques (micro-BIC, micro-foncier). Pour votre déclaration officielle, utilisez impots.gouv.fr.",
    },
  ],
  relatedSlugs: [
